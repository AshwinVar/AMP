...
"""
from ai import base, prediction, recommendations, copilot, insights, twin, impact, pulse, roster, trends, downtime, quality, production, oee, inventory, flow, shift, losses, recovery, briefing, delivery, cost, handover, scorecard, maintenance, report, assistant, platform_status, compliance, search, supply, reliability, connectivity, schedule, schedule_load, coverage, trace, workforce, stock_health  # noqa: F401  (re-export the platform surface)
