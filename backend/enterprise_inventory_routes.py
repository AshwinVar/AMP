...
def register(app):
    ...
    @app.patch("/issue-slips/{sid}/approve")
    ...
    @app.patch("/issue-slips/{sid}/issue")
    ...
    @app.patch("/issue-slips/{sid}/reject")
    ...
    @app.patch("/cycle-counts/{cid}/approve")
    ...
    @app.get("/inventory/variance-report")
