...
@router.get("/reports/intelligence-summary.txt")
...
@router.get("/reports", response_model=List[schemas.ReportRequestResponse])
...
@router.post("/reports", response_model=schemas.ReportRequestResponse)
