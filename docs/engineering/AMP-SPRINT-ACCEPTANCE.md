...
- **Recovery has been timed on a small dataset and on a production-sized one**
  (2,200 machines, 66,000 production records, a 5 MB dump: RTO 9.23 s against
  7.73 s at demo size, both locally with the dump on disk — closure document
  §8). Not timed: a year of production, or the artifact download.
