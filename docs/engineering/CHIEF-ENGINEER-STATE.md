...
**Master SHA:** `0830962` (#706).
**Production SHA:** `0830962`, verified live, not assumed: `/health` returned
`version: 0830962` on 2026-09-22 05:13 UTC, minutes after the merge; `/readiness`
200; `/command-centre`, `/risk-radar` and `/wip-aging` each refuse an
unauthenticated call with 401; the frontend 200. Before it, #705 `e669146` at
