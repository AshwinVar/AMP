...
**Master SHA:** `21278b8` (#707).
**Production SHA:** `21278b8`, verified live, not assumed: `/health` returned
`version: 21278b8` on 2026-09-22 06:43 UTC, minutes after the merge; `/readiness`
200; `/command-centre`, `/daily-brief` and `/machine-health` each refuse an
unauthenticated call with 401; the frontend 200. Before it, #706 `0830962` at
05:13 UTC and #705 `e669146` at 04:31 UTC, verified the same way. Before it, #705 `e669146` at
