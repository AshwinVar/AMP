...
**Master SHA:** `e8cffb1` (#704).
**Production SHA:** `e8cffb1`, verified live, not assumed: `/health` returned
`version: e8cffb1` on 2026-09-22 03:44 UTC, minutes after the merge; `/readiness`
200, `POST /production-records` refuses an unauthenticated call with 401, and the
frontend 200. Before it, #703 `5ac43fa` at 03:15 UTC and #702 `2fa89a3` at 02:26 UTC
