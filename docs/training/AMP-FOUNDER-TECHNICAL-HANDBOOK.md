...
|---|---|---|---|
| **Operator** | all factory reads (tenant-scoped) | shop-floor writes: production, machine status, quality checks, WO progress, ack notifications | admin writes; **approve agent actions**; **edit an agent proposal still awaiting approval** (nobody can — see below); deletes/voids; user/BOM/config admin |
